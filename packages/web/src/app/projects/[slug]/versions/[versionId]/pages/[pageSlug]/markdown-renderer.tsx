...
const SAFE_URL_SCHEMES = new Set(["http", "https", "mailto", "cite", ""]);
...
export function MarkdownRenderer({
  ...
  return (
    <ReactMarkdown
      ...
      // rehypeRaw runs FIRST so raw HTML inside markdown is parsed, then
      // rehypeSanitize strips any script/event-handler/unsafe-URL payload,
      // then rehypeHighlight colors code blocks. Keep this order.
      rehypePlugins={[
        rehypeRaw,
